    ...
    public var body: some HTML {
        ...
        script {
            ...
            window.addEventListener('message', e => {
                ...
                fetch('/canvas-py/push?scalable=' + scaledToggle.checked + '&smoothRectangle=' + smoothRectangleToggle.checked + '&smoothRoundedRectangle=' + smoothRoundedRectangleToggle.checked + '&smoothEllipse=' + smoothEllipseToggle.checked + '&smoothTriangle=' + smoothTriangleToggle.checked + '&smoothLine=' + smoothLineToggle.checked, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: e.data.data
                });
